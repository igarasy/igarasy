...
- ⚙️ Passionate about **clean architecture**, **smooth UX** and **scalable mobile apps**  
- 📈 Obsessed with metrics like **load time**, **crash-free rate**, and **user retention**  
- 🧩 Advocate of **cross-platform development** and **shared UI systems**  
- 🧠 Constantly exploring tools that improve developer productivity and app reliability  
- 🌎 Open for collaboration, freelancing and new challenges in mobile engineering  
...
- **Testing:** XCTest · Flutter Test · Jest
- **Monitoring:** Sentry · Firebase Crashlytics · Datadog  
- **Architecture:** Clean · MVVM · Riverpod · Provider · Redux  
...
<div>
  ...
  <a href="mailto:lucas.igarashi.dev@gmail.com" target="_blank">
